export const accItems = [
    {
      title: 'É possível jogar o modo demo gratuitamente?',
      body: `Sim, temos a oportunidade de jogar no modo de demonstração de forma
        absolutamente gratuita. Isto permite-lhe experimentar os jogos sem apostar
